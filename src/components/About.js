const About = () => {
    return (
        <section className='about'>
            <h2>About Me</h2>
            <p>
            Smart Contract & Blockchain Developer with 1+ years of expertise, skilled at writing, testing, deploying and auditing Smart Contracts by taking care of gas optimisation and security.
            </p>
                <br></br>
            <p>
