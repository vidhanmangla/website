                        ...
                        <div className="projects__card">
                            <h3>zk Documents</h3>
                                <img src={zkp} alt="zk proof" />
                                    <p>
                                        Verification of documents without revealing the information in it by using zero-knowledge cryptography.
                                    </p>
                                <a align="center" href="mailto:vidhanmangla@gmail.com" target="_blank" rel="noreferrer" className="button">Available Locally</a>
                        </div>
